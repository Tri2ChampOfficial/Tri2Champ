            ...
            {menuItems.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <a href="./register">
                    <button  className="bg-emerald-600 event-button text-zinc-950 mt-10 hover:text-zinc-50 border-2 border-indigo-950 hover:border-indigo-50 rounded-xl hover:bg-emerald-800">
                      Register Now!!
                    </button>
                  </a>
                </div>
